...
class mwmod_mw_bootstrap_output_man extends mw_apsubbaseobj{
	...
	function get_html_group_with_title($input){
		...
		$r.="<div class='card-group mwfrmgr' id='$gr_id'>\n";
		$r.="<div class='card card-default'>\n";
		
		$r.="<div class='card-header'>\n";
		$r.="<div data-toggle='collapse' data-auto-target-parent='#$gr_id' href='#$p_id' style='cursor:pointer' data-auto-target='.collapse' class='' aria-expanded='false'>\n";
	...
	function get_full_btnsgroup_html($input){
		$r="";
		$r.="<div class='d-grid gap-2 d-md-flex justify-content-md-end'>\n";
		$r.= $input->get_html_bootstrap_children($this);
		$r.="</div>\n";
		return $r;
