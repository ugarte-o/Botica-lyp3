<?php
/**
 * Users2 - Default UserData Configuration
 * 
 * @package mwmod_mw_users2
 * @subpackage def
 * @since 2026-03
 */
class mwmod_mw_users2_def_userdata extends mwmod_mw_users2_userdata {

    public function __construct($man) {
        parent::__construct($man);
    }

    public function create_profile_imgs_group($user) {
        $man = new mwmod_mw_helper_img_gr_imgsgr();
        $this->init_profile_imgs_group($man, $user);
        return $man;
    }

    public function set_cfg_profile_imgs_group($group, $user): void {
