<?php
class mwmod_mw_users_ui_user_rols extends mwmod_mw_users_ui_user_abs{
	...
	function do_exec_page_in(){
		...
		$msg="";
		$dm->savefromfrm_user_rols(new mwmod_mw_helper_inputvalidator_request("nduser.usernd"),$user,$msg);
		//mw_array2list_echo($_REQUEST);
		$dm->set_user_rols_cr($user,$cr);
